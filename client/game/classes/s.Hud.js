s.HUD = new Class({
	construct: function(options){
		...
		this.subreticleBound.left = this.canvas.width/2 - this.canvas.width/6;
		this.subreticleBound.right = this.canvas.width/2 + this.canvas.width/6;
		this.subreticleBound.top = this.canvas.height/2 - this.canvas.height/6;
		this.subreticleBound.bottom = this.canvas.height/2 + this.canvas.height/6;
